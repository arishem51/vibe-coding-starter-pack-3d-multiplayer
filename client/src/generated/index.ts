...
const tablesSchema = __schema({
  ...
  projectile: __table({
    name: 'projectile',
    indexes: [
      { accessor: 'projectile_id', name: 'projectile_projectile_id_idx_btree', algorithm: 'btree', columns: [
        'projectileId',
      ] },
    ],
    constraints: [
      { name: 'projectile_projectile_id_key', constraint: 'unique', columns: ['projectileId'] },
    ],
  }, ProjectileRow),
  room: __table({
    name: 'room',
...
const reducersSchema = __reducers(
  __reducerSchema("car_hit", CarHitReducer),
  __reducerSchema("create_room", CreateRoomReducer),
  __reducerSchema("crossed_car_road", CrossedCarRoadReducer),
  __reducerSchema("destroy_projectile", DestroyProjectileReducer),
  __reducerSchema("force_end", ForceEndReducer),
  ...
  __reducerSchema("submit_bonus_answer", SubmitBonusAnswerReducer),
  __reducerSchema("toggle_shield", ToggleShieldReducer),
